//button that makes information box appear (Credit/Debit)
function Disapear(){
...
function saveThenDirect(){
    ...
    if (lastname && email && firstname && PhoneCred && card && CreDeb && CardDigit && SecurityDigit && ExpDate && Bill) {
        localStorage.setItem('paymentType', 'credit');
...
// Pay on Arrival Thank You page (ThankYou.html)
